...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_4.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:11pt; font-weight:600;\">Hoşgeldiniz!<br/>Hesabınıza giriş yapın</span></p></body></html>"))
        ...
        self.label_or.setText(_translate("Dialog", "<html><head/><body><p>veya</p></body></html>"))
        self.label_6.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:11pt; font-weight:600;\">Operatör olarak devam edin</span></p></body></html>"))
