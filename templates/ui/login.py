...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/images/templates/images/microchip.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        self.verticalLayout_2.setContentsMargins(-1, 40, -1, 0)
        ...
        self.lineEdit_username = QtWidgets.QLineEdit(self.widget_8)
        ...
        self.label_username_warning = QtWidgets.QLabel(self.widget_8)
        self.label_username_warning.setStyleSheet("color: red;")
        self.label_username_warning.setObjectName("label_username_warning")
        self.verticalLayout_6.addWidget(self.label_username_warning)
...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/images/templates/images/view.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon1.addPixmap(QtGui.QPixmap(":/images/templates/images/unview.svg"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.pushButton_show_password.setIcon(icon1)
        ...
        self.verticalLayout_5.addWidget(self.label_password_warning)
        ...
        self.verticalLayout_4.setContentsMargins(-1, 0, -1, 40)
