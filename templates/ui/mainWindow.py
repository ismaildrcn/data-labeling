...
"}")
        ...
        self.widget_labeling_bottom_area = QtWidgets.QWidget(self.page_labeling)
        ...
        self.layout_image_count = QtWidgets.QFormLayout()
        self.layout_image_count.setObjectName("layout_image_count")
        self.label_image_title = QtWidgets.QLabel(self.widget_labeling_bottom_area)
        self.label_image_title.setObjectName("label_image_title")
        self.layout_image_count.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_image_title)
        self.label_total_image_value = QtWidgets.QLabel(self.widget_labeling_bottom_area)
        self.label_total_image_value.setText("")
        self.label_total_image_value.setObjectName("label_total_image_value")
        self.layout_image_count.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.label_total_image_value)
        self.horizontalLayout_5.addLayout(self.layout_image_count)
        self.layout_annotation_count = QtWidgets.QFormLayout()
        self.layout_annotation_count.setObjectName("layout_annotation_count")
        self.label_total_annotation_title = QtWidgets.QLabel(self.widget_labeling_bottom_area)
        ...
        self.label_total_annotation_value = QtWidgets.QLabel(self.widget_labeling_bottom_area)
        ...
        self.horizontalLayout_5.addLayout(self.layout_annotation_count)
        self.formLayout = QtWidgets.QFormLayout()
        self.formLayout.setObjectName("formLayout")
        self.label_defined_annotation_title = QtWidgets.QLabel(self.widget_labeling_bottom_area)
        self.label_defined_annotation_title.setObjectName("label_defined_annotation_title")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_defined_annotation_title)
        self.label_defined_annotation_value = QtWidgets.QLabel(self.widget_labeling_bottom_area)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.label_defined_annotation_value)
        self.horizontalLayout_5.addLayout(self.formLayout)
        self.verticalLayout_2.addWidget(self.widget_labeling_bottom_area)
