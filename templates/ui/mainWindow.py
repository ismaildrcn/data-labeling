...
"}")
        ...
        self.layout_image_list.addWidget(self.widget_2)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_drop_project.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600;\">Geçmiş proje arşiv dosyasını bırakın </span></p><p align=\"center\"><span style=\" font-size:11pt;\">veya </span></p><p align=\"center\"><span style=\" font-size:11pt; font-weight:600;\">Seçmek için buraya tıklayın</span></p></body></html>"))
        ...
        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:11pt;\">Başlamadan önce, projenizdeki nesnelere atamayı planladığınız etiketlerin bir listesini İngilizce olmak kaydıyla istediğiniz gibi oluşturabilirsiniz.</span></p></body></html>"))
