...
"}")
        ...
        self.label_authorized_icon = QtWidgets.QLabel(self.widget_personel_state)
        self.label_authorized_icon.setMinimumSize(QtCore.QSize(22, 22))
        self.label_authorized_icon.setMaximumSize(QtCore.QSize(22, 22))
        self.label_authorized_icon.setText("")
        self.label_authorized_icon.setPixmap(QtGui.QPixmap(":/images/templates/images/document-cross.svg"))
        self.label_authorized_icon.setScaledContents(True)
        self.label_authorized_icon.setObjectName("label_authorized_icon")
        self.horizontalLayout_15.addWidget(self.label_authorized_icon)
